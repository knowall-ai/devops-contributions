  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(commit: CommitContribution) => (
          <Commit commit={commit} showDay={this.props.showDay} />
        )}
      />
    );
  }
  ...
  render() {
    return (
      <Contributions
        ...
        items={this.props.allContributions.filter(
          (c) => c instanceof CreatePullRequestContribution
        )}
        onRenderItem={(pr: CreatePullRequestContribution) => (
          <PullRequest pullrequest={pr} showDay={this.props.showDay} />
        )}
      />
    );
  }
  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(pr: ClosePullRequestContribution) => (
          <PullRequest pullrequest={pr} showDay={this.props.showDay} />
        )}
      />
    );
  ...
  render() {
    return (
      <Contributions
        ...
        items={this.props.allContributions.filter(
          (c) => c instanceof ReviewPullRequestContribution
        )}
        onRenderItem={(pr: ReviewPullRequestContribution) => (
          <PullRequest pullrequest={pr} showDay={this.props.showDay} />
        )}
      />
    );
  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(wi: CreateWorkItemContribution) => (
          <WorkItemComponent workItem={wi} showDay={this.props.showDay} />
        )}
      />
    );
  }
  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(wi: ResolveWorkItemContribution) => (
          <WorkItemComponent workItem={wi} showDay={this.props.showDay} />
        )}
      />
    );
  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(wi: CloseWorkItemContribution) => (
          <WorkItemComponent workItem={wi} showDay={this.props.showDay} />
        )}
      />
    );
  ...
  render() {
    return (
      <Contributions
        ...
        onRenderItem={(c: ChangesetContribution) => (
          <Changeset changeset={c} showDay={this.props.showDay} />
        )}
      />
    );
  }
...
> {
  render() {
    ...
    return (
      <CollapsibleHeader
        title={title}
        buttonName={label.replace("# ", "").toLocaleLowerCase()}
        className={count === 0 ? "hidden" : ""}
        level={4}
      >
        <FocusZone direction={FocusZoneDirection.vertical}>
          <List items={this.props.items} onRenderCell={this.props.onRenderItem} />
        </FocusZone>
      </CollapsibleHeader>
    );
  }
